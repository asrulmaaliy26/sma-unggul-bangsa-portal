              ...
              <div className="space-y-8 text-slate-700">
                 ...
                 <div>
                    ...
                    <p className="leading-relaxed">
                       Penelitian ini dilakukan dalam kurun waktu semester genap dengan fokus pada metodologi deskriptif analitis. Berdasarkan data yang dikumpulkan melalui observasi lapangan di lingkungan SMA Unggul Bangsa, didapatkan temuan menarik yang membuktikan hipotesis awal mengenai variabel yang diteliti.
                    </p>
